...
import com.androidproject.androidproject.MainActivity;
...
public class GoogleVisionClient {
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyDLfRDrjfNUAcb8edQjJ_lSyVRq-ndMO2Q";
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) throws IOException {
        ...
        if (labels != null) {
            EntityAnnotation bestLabel = labels.get(0);
            return bestLabel.getDescription();
        } else {
